...
int CALLBACK wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR lpCmdLine, int nCmdShow) {
    ...
    // vireo::backend::RenderingBackends backendType{vireo::backend::RenderingBackends::VULKAN};
    // title.append(L"Vulkan 1.3");
    vireo::backend::RenderingBackends backendType{vireo::backend::RenderingBackends::DIRECTX};

...
constexpr char error_lua_stack_overflow[] = "stack overflow";
...
template <class T>
constexpr bool has_member_message_v = has_member_message<T>::value;
} 
...
constexpr const auto& unexpect = UnexpectType();
...
[[nodiscard]] constexpr auto typeHash() noexcept
{
...
template <class F>
constexpr bool function_is_member_v = function_traits<F>::is_member;

template <class F>
constexpr bool function_is_const_v = function_traits<F>::is_const;
...
template <class T>
constexpr bool is_const_member_function_pointer_v = is_const_member_function_pointer<T>::value;
...
template <class T>
constexpr bool is_cfunction_pointer_v = is_cfunction_pointer<T>::value;
...
template <class T>
constexpr bool is_member_cfunction_pointer_v = is_member_cfunction_pointer<T>::value;
...
template <class T>
constexpr bool is_const_member_cfunction_pointer_v = is_const_member_cfunction_pointer<T>::value;

template <class T>
constexpr bool is_any_cfunction_pointer_v = is_cfunction_pointer_v<T> || is_member_cfunction_pointer_v<T>;

template <class T, class F>
constexpr bool is_proxy_member_function_v =
    !std::is_member_function_pointer_v<F> &&
    std::is_same_v<T, remove_cvref_t<std::remove_pointer_t<function_argument_or_void_t<0, F>>>>;

template <class T, class F>
constexpr bool is_const_proxy_function_v =
...
constexpr std::size_t function_arity_excluding_v = function_arity_excluding<function_arguments_t<F>, ExclusionType>::value;
...
constexpr std::size_t member_function_arity_excluding_v = member_function_arity_excluding<T, F, function_arguments_t<F>, ExclusionType>::value;
...
constexpr std::size_t const_functions_count = (0 + ... + (is_const_function<T, Fs> ? 1 : 0));

template <class T, class... Fs>
constexpr std::size_t non_const_functions_count = (0 + ... + (is_const_function<T, Fs> ? 0 : 1));
...
constexpr Options defaultOptions = Options();

constexpr Options extensibleClass = Options::Value<detail::OptionExtensibleClass>();

constexpr Options allowOverridingMethods = Options::Value<detail::OptionAllowOverridingMethods>();

constexpr Options visibleMetatables = Options::Value<detail::OptionVisibleMetatables>();

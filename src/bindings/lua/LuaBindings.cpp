...
namespace vireo {
    ...
    void LuaBindings::_register(lua_State* L) {
        ...
        .beginClass<Semaphore>("Semaphore")
            .addProperty("type",  &Semaphore::getType)
            .addProperty("value", &Semaphore::getValue, &Semaphore::setValue)
        ...
        .beginClass<PhysicalDevice>("PhysicalDevice")
            .addProperty("description", &PhysicalDevice::getDescription)
        .endClass()
        .beginClass<Device>("Device")
            .addProperty("have_dedicated_transfer_queue", &Device::haveDedicatedTransferQueue)
        .endClass()
        .beginClass<Buffer>("Buffer")
            .addProperty("size",                  &Buffer::getSize)
            .addProperty("type",                  &Buffer::getType)
            .addProperty("instance_size",         &Buffer::getInstanceSize)
            .addProperty("instance_size_aligned", &Buffer::getInstanceSizeAligned)
            .addProperty("instance_count",        &Buffer::getInstanceCount)
            .addProperty("mapped_address",        &Buffer::getMappedAddress)
        ...
        .beginClass<Image>("Image")
            .addProperty("format",     &Image::getFormat)
            .addProperty("width",      &Image::getWidth)
            .addProperty("height",     &Image::getHeight)
            .addProperty("mip_levels", &Image::getMipLevels)
            .addProperty("array_size", &Image::getArraySize)
            .addProperty("is_read_write", &Image::isReadWrite)
        ...
        .beginClass<RenderTarget>("RenderTarget")
            .addProperty("image", &RenderTarget::getImage)
            .addProperty("type",  &RenderTarget::getType)
        .endClass()
        .beginClass<DescriptorLayout>("DescriptorLayout")
            .addFunction("add",               &DescriptorLayout::add)
            .addFunction("build",             &DescriptorLayout::build)
            .addProperty("capacity",          &DescriptorLayout::getCapacity)
            .addProperty("is_dynamic_uniform",&DescriptorLayout::isDynamicUniform)
            .addProperty("is_samplers",       &DescriptorLayout::isSamplers)
        .endClass()
        .beginClass<DescriptorSet>("DescriptorSet")
            ...
            .addProperty("layout", &DescriptorSet::getLayout)
        .endClass()
        ...
        .beginClass<Pipeline>("Pipeline")
            .addProperty("resources", &Pipeline::getResources)
            .addProperty("type",      &Pipeline::getType)
        .endClass()
        ...
        .beginClass<SwapChain>("SwapChain")
            .addProperty("extent",              &SwapChain::getExtent)
            .addProperty("aspect_ratio",        &SwapChain::getAspectRatio)
            .addProperty("current_frame_index", &SwapChain::getCurrentFrameIndex)
            .addProperty("frames_in_flight",    &SwapChain::getFramesInFlight)
            .addProperty("format",              &SwapChain::getFormat)
        ...
        .beginClass<CommandAllocator>("CommandAllocator")
            ...
            .addProperty("command_list_type", &CommandAllocator::getCommandListType)
        .endClass()
        ...
        .beginClass<Vireo>("Vireo")
            ...
            .addProperty("shader_file_extension",    &Vireo::getShaderFileExtension)
            .addProperty("physical_device",          &Vireo::getPhysicalDevice)
            .addProperty("device",                   &Vireo::getDevice)
            .addProperty("instance",                 &Vireo::getInstance)
        .endClass()

...
export namespace dx12 {
    ...
    public:
        Application(HINSTANCE hInstance) {
            ...
            HRESULT hr = dxgiAdapter4->GetDesc3(&desc);
            if (SUCCEEDED(hr)) {
    ...
    LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
        {
        Application* app = static_cast<Application*>(appInstance);
            if ( app->g_IsInitialized )
            {
                ...
                case WM_KEYDOWN:
                {
                    ...
                    case VK_RETURN:
                        ...
                        {
                            case VK_F11:
                                app->SetFullscreen(!app->g_Fullscreen);
                        }
                        break;
                    }
                }
                ...
                {
                    RECT clientRect = {};
                    ::GetClientRect(app->g_hWnd, &clientRect);
